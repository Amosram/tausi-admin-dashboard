  ...
  const statsItems = [
    {
      ...
      value: formatter.format(data?.data.verifications.total_applications),
      bgColor: "bg-card ",
    ...
    },
    {
      ...
      value: formatter.format(data?.data.verifications.pending_applications),
      bgColor: "bg-card ",
    ...
    },
    {
      ...
      value: formatter.format(data?.data.verifications.rejected_applications),
      bgColor: "bg-card ",
    ...
    },
    {
      ...
      value: formatter.format(data?.data.verifications.applications_under_review),
      bgColor: "bg-card ",

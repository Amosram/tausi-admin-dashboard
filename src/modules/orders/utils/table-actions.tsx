...
export const printSelectedRows = <TData,>(
  ...
  printWindow.document.write("<html><head><title>Selected Orders</title>");
    ...
    navigator.clipboard
      ...
      .then(() => {
        toast({
          ...
          description: "Selected orders have been copied to clipboard",
        });
      })
      .catch((err) => {
        toast({
          title: "Share Failed",
          description: "Unable to share or copy selected orders",
          variant: "destructive",
        });
      });
  }

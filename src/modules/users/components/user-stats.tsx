          ...
          >
            ...
            {item.link && (
              <CardFooter className="p-4 pt-0">
                <Button
                  variant="outline"
                  className="w-full text-xs hover:bg-opacity-20 border-opacity-50 transition-colors hover:bg-primary hover:text-white dark:hover:bg-orange-600 dark:hover:text-gray-300"
                  asChild
                >
                  <Link
                    to={{
